...
private struct DashboardView: View {
    ...
    private var contactPanel: some View {
        VStack(spacing: 12) {
            contactButton(title: "Discord", subtitle: "Join the IPA developer's Discord.", icon: "bubble.left.fill", tint: accent, url: "https://discord.gg/aBQyPTbpgc")
            contactButton(title: "WhatsApp", subtitle: "Contact me", icon: "message.fill", tint: accent, url: "https://wa.me/message/ENPUX2DI3TPDE1")
